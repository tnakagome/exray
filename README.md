...
libexray.so can help you in such cases. By restarting your program with libexray.so attached by LDP_RELOAD, you can see C++ exception information that the program throws. Run the program until it cores, then give the output along with the core file to your developers. It may help them identify the source of the problem and hopefully fix the core.
